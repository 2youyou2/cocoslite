...
var TerrainComponent = ck.Component.extend({
    ...
    recreatePath: function(){
        ...
        if (this._mesh.materials.length == 0 || this._mesh.materials[0].file != terrainMaterial.edgeMaterial || this._mesh.materials[1].file != terrainMaterial.fillMaterial)
        {
            this._mesh.materials.set(0, terrainMaterial.edgeMaterial);
            this._mesh.materials.set(1, terrainMaterial.fillMaterial);
        ...
        this._mesh.setSubMesh(0, submesh1);
        this._mesh.setSubMesh(1, submesh2);
