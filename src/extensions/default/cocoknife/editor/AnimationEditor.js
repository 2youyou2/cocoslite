define(function (require, exports, module) {
    ...
    function test(scene){
        ...
        var Box2DTestLayer = cc.Layer.extend({
            ...
            ctor:function () {
                ...
                var mgr = new cc.SpriteBatchNode("2.png", 150);
            ...
            addNewSpriteWithCoords:function (p) {
                ...
                dynamicBox.SetAsBox(sprite.width/ PTM_RATIO/2, sprite.height/ PTM_RATIO/2);//These are mid points for our 1m box
    ...
    EditorManager.on("activeEditorChange", function(event, current, previous){
        ...
        if(!current || !current.document.file.name.endWith(".js.ani")) {
            return;
        }
        ...
        current.document.getText = function(){
